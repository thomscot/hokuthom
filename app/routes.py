    ...
    T = {
        ...
        "jp": {
            ...
            "long_story_paragraph": (
                ...
                "</br></br>"
                "同時に、芸術と文化への継続的な関わりも途切れたことはありません。幼少期からピアノを学び、1990年代後半から武道を続け、近年は日本文化を言語的・美的に掘り下げる方法として書道（書道院〈Shodan-in〉に2017年より所属）にも取り組んでいます。2021年には初の小説を刊行し、その後も日本を舞台にした作品を発表してきました。執筆を通じて、ステレオタイプを避けながら、現代日本の多層的な姿をイタリアの読者へ伝える文化発信も行っています。"
                "</br></br>"
